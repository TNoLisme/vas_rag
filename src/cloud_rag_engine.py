...
class VASCloudSystem:
    def __init__(self, vector_db_path="vector_db/"):
        print("\n" + "-" * 60)
        print("[INIT] KHỞI TẠO HỆ THỐNG ONLY CLOUD (GEMINI)")
        self.cloud_llm = ChatGoogleGenerativeAI(model="gemini-2.5-flash-lite", temperature=0.0)
...
""")
        ...
        print(f"[NODE: RETRIEVE] Model: Cloud Gemini")
